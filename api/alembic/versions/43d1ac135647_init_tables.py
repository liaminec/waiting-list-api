...
def upgrade() -> None:
    ...
    sa.Column('venue_name', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('venue_address', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    ...
    sa.ForeignKeyConstraint(['type_id'], ['offertype.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['representation_id'], ['representation.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
